...
static PyObject* pyopencv_cv_Algorithm__create(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv;
    ...
    {
        ERRWRAP2(retval = cv::Algorithm::_create(name));
        return pyopencv_from(retval);
    }
...
static PyObject* pyopencv_cv_Algorithm_getList(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv;
    ...
    {
        ERRWRAP2(cv::Algorithm::getList(algorithms));
...
static PyObject* pyopencv_cv_HOGDescriptor_HOGDescriptor(PyObject* , PyObject* args, PyObject* kw)
{
        ...
        pyopencv_to(pyobj__cellSize, _cellSize, ArgInfo("_cellSize", 0)) )
    {
        self = PyObject_NEW(pyopencv_HOGDescriptor_t, &pyopencv_HOGDescriptor_Type);
        new (&(self->v)) Ptr<cv::HOGDescriptor>(); // init Ptr with placement new
        if(self) ERRWRAP2(self->v.reset(new cv::HOGDescriptor(_winSize, _blockSize, _blockStride, _cellSize, _nbins, _derivAperture, _winSigma, _histogramNormType, _L2HysThreshold, _gammaCorrection, _nlevels)));
        return (PyObject*)self;
    }
    }
    PyErr_Clear();
...
static PyObject* pyopencv_cv_findTransformECC(PyObject* , PyObject* args, PyObject* kw)
{
    ...
    const char* keywords[] = { "templateImage", "inputImage", "warpMatrix", "motionType", "criteria", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOO|iO:findTransformECC", (char**)keywords, &pyobj_templateImage, &pyobj_inputImage, &pyobj_warpMatrix, &motionType, &pyobj_criteria) &&
        ...
        pyopencv_to(pyobj_criteria, criteria, ArgInfo("criteria", 0)) )
    {
        ERRWRAP2(retval = cv::findTransformECC(templateImage, inputImage, warpMatrix, motionType, criteria));
...
static PyObject* pyopencv_cv_ocl_isPerformanceCheckBypassed(PyObject* , PyObject* args, PyObject* kw)
{
    using namespace cv::ocl;
    ...
    if(PyObject_Size(args) == 0 && (kw == NULL || PyObject_Size(kw) == 0))
    {
        ERRWRAP2(retval = cv::ocl::isPerformanceCheckBypassed());
        return pyopencv_from(retval);
    }
