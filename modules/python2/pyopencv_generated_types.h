...
template<> bool pyopencv_to(PyObject* src, cv::ml::ANN_MLP::Params& dst, const char* name);
...
template<> bool pyopencv_to(PyObject* src, cv::ml::Boost::Params& dst, const char* name);
...
template<> bool pyopencv_to(PyObject* src, cv::ml::DTrees::Params& dst, const char* name);
...
template<> bool pyopencv_to(PyObject* src, cv::ml::EM::Params& dst, const char* name);
...
template<> bool pyopencv_to(PyObject* src, cv::ml::KNearest::Params& dst, const char* name);
...
struct pyopencv_ml_NormalBayesClassifier_Params_t
{
    PyObject_HEAD
    Ptr<cv::ml::NormalBayesClassifier::Params> v;
};

static PyTypeObject pyopencv_ml_NormalBayesClassifier_Params_Type =
{
    PyObject_HEAD_INIT(&PyType_Type)
0,
    MODULESTR".ml_NormalBayesClassifier_Params",
    sizeof(pyopencv_ml_NormalBayesClassifier_Params_t),
};

static void pyopencv_ml_NormalBayesClassifier_Params_dealloc(PyObject* self)
{
    ((pyopencv_ml_NormalBayesClassifier_Params_t*)self)->v.release();
    PyObject_Del(self);
}

template<> PyObject* pyopencv_from(const Ptr<cv::ml::NormalBayesClassifier::Params>& r)
{
    pyopencv_ml_NormalBayesClassifier_Params_t *m = PyObject_NEW(pyopencv_ml_NormalBayesClassifier_Params_t, &pyopencv_ml_NormalBayesClassifier_Params_Type);
    new (&(m->v)) Ptr<cv::ml::NormalBayesClassifier::Params>(); // init Ptr with placement new
    m->v = r;
    return (PyObject*)m;
}

template<> bool pyopencv_to(PyObject* src, Ptr<cv::ml::NormalBayesClassifier::Params>& dst, const char* name)
{
    if( src == NULL || src == Py_None )
        return true;
    if(!PyObject_TypeCheck(src, &pyopencv_ml_NormalBayesClassifier_Params_Type))
    {
        failmsg("Expected cv::ml::NormalBayesClassifier::Params for argument '%s'", name);
        return false;
    }
    dst = ((pyopencv_ml_NormalBayesClassifier_Params_t*)src)->v.dynamicCast<cv::ml::NormalBayesClassifier::Params>();
    return true;
}


template<> bool pyopencv_to(PyObject* src, cv::ml::ParamGrid& dst, const char* name);
...
template<> bool pyopencv_to(PyObject* src, cv::ml::RTrees::Params& dst, const char* name);
...
template<> bool pyopencv_to(PyObject* src, cv::ml::SVM::Params& dst, const char* name);
...
static PyObject* pyopencv_cv_Algorithm_getAlgorithm(PyObject* self, PyObject* args, PyObject* kw)
{
    using namespace cv;
...
static PyObject* pyopencv_cv_Algorithm_getBool(PyObject* self, PyObject* args, PyObject* kw)
{
    using namespace cv;
...
static PyObject* pyopencv_cv_Algorithm_getDouble(PyObject* self, PyObject* args, PyObject* kw)
{
    using namespace cv;
...
static PyObject* pyopencv_cv_Algorithm_getInt(PyObject* self, PyObject* args, PyObject* kw)
{
    using namespace cv;
...
static PyObject* pyopencv_cv_Algorithm_getMat(PyObject* self, PyObject* args, PyObject* kw)
{
    using namespace cv;
...
static PyObject* pyopencv_cv_Algorithm_getMatVector(PyObject* self, PyObject* args, PyObject* kw)
{
    using namespace cv;
...
static PyObject* pyopencv_cv_Algorithm_getParams(PyObject* self, PyObject* args, PyObject* kw)
{
    using namespace cv;
...
static PyObject* pyopencv_cv_Algorithm_getString(PyObject* self, PyObject* args, PyObject* kw)
{
    using namespace cv;
...
static PyObject* pyopencv_cv_Algorithm_paramHelp(PyObject* self, PyObject* args, PyObject* kw)
{
    using namespace cv;
...
static PyObject* pyopencv_cv_Algorithm_paramType(PyObject* self, PyObject* args, PyObject* kw)
{
    using namespace cv;
...
static PyObject* pyopencv_cv_Algorithm_setAlgorithm(PyObject* self, PyObject* args, PyObject* kw)
{
    using namespace cv;
...
static PyObject* pyopencv_cv_Algorithm_setBool(PyObject* self, PyObject* args, PyObject* kw)
{
    using namespace cv;
...
static PyObject* pyopencv_cv_Algorithm_setDouble(PyObject* self, PyObject* args, PyObject* kw)
{
    using namespace cv;
...
static PyObject* pyopencv_cv_Algorithm_setInt(PyObject* self, PyObject* args, PyObject* kw)
{
    using namespace cv;
...
static PyObject* pyopencv_cv_Algorithm_setMat(PyObject* self, PyObject* args, PyObject* kw)
{
    using namespace cv;
...
static PyObject* pyopencv_cv_Algorithm_setMatVector(PyObject* self, PyObject* args, PyObject* kw)
{
    using namespace cv;
...
static PyObject* pyopencv_cv_Algorithm_setString(PyObject* self, PyObject* args, PyObject* kw)
{
    using namespace cv;
...
{
    {"getAlgorithm", (PyCFunction)pyopencv_cv_Algorithm_getAlgorithm, METH_VARARGS | METH_KEYWORDS, "getAlgorithm(name) -> retval"},
    {"getBool", (PyCFunction)pyopencv_cv_Algorithm_getBool, METH_VARARGS | METH_KEYWORDS, "getBool(name) -> retval"},
    {"getDouble", (PyCFunction)pyopencv_cv_Algorithm_getDouble, METH_VARARGS | METH_KEYWORDS, "getDouble(name) -> retval"},
    {"getInt", (PyCFunction)pyopencv_cv_Algorithm_getInt, METH_VARARGS | METH_KEYWORDS, "getInt(name) -> retval"},
    {"getMat", (PyCFunction)pyopencv_cv_Algorithm_getMat, METH_VARARGS | METH_KEYWORDS, "getMat(name) -> retval"},
    {"getMatVector", (PyCFunction)pyopencv_cv_Algorithm_getMatVector, METH_VARARGS | METH_KEYWORDS, "getMatVector(name) -> retval"},
    {"getParams", (PyCFunction)pyopencv_cv_Algorithm_getParams, METH_VARARGS | METH_KEYWORDS, "getParams() -> names"},
    {"getString", (PyCFunction)pyopencv_cv_Algorithm_getString, METH_VARARGS | METH_KEYWORDS, "getString(name) -> retval"},
    {"paramHelp", (PyCFunction)pyopencv_cv_Algorithm_paramHelp, METH_VARARGS | METH_KEYWORDS, "paramHelp(name) -> retval"},
    {"paramType", (PyCFunction)pyopencv_cv_Algorithm_paramType, METH_VARARGS | METH_KEYWORDS, "paramType(name) -> retval"},
    {"setAlgorithm", (PyCFunction)pyopencv_cv_Algorithm_setAlgorithm, METH_VARARGS | METH_KEYWORDS, "setAlgorithm(name, value) -> None"},
    {"setBool", (PyCFunction)pyopencv_cv_Algorithm_setBool, METH_VARARGS | METH_KEYWORDS, "setBool(name, value) -> None"},
    {"setDouble", (PyCFunction)pyopencv_cv_Algorithm_setDouble, METH_VARARGS | METH_KEYWORDS, "setDouble(name, value) -> None"},
    {"setInt", (PyCFunction)pyopencv_cv_Algorithm_setInt, METH_VARARGS | METH_KEYWORDS, "setInt(name, value) -> None"},
    {"setMat", (PyCFunction)pyopencv_cv_Algorithm_setMat, METH_VARARGS | METH_KEYWORDS, "setMat(name, value) -> None"},
    {"setMatVector", (PyCFunction)pyopencv_cv_Algorithm_setMatVector, METH_VARARGS | METH_KEYWORDS, "setMatVector(name, value) -> None"},
    {"setString", (PyCFunction)pyopencv_cv_Algorithm_setString, METH_VARARGS | METH_KEYWORDS, "setString(name, value) -> None"},
...
static bool pyopencv_to(PyObject* src, cv::ml::ParamGrid& dst, const char* name)
{
    PyObject* tmp;
    bool ok;

    if( PyMapping_HasKeyString(src, (char*)"minVal") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"minVal");
        ok = tmp && pyopencv_to(tmp, dst.minVal);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"maxVal") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"maxVal");
        ok = tmp && pyopencv_to(tmp, dst.maxVal);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"logStep") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"logStep");
        ok = tmp && pyopencv_to(tmp, dst.logStep);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    return true;
...
{
    pyopencv_ml_NormalBayesClassifier_Type.tp_base = NULL;
...
static PyObject* pyopencv_ml_NormalBayesClassifier_Params_repr(PyObject* self)
{
    char str[1000];
    sprintf(str, "<ml_NormalBayesClassifier_Params %p>", self);
    return PyString_FromString(str);
}



static PyGetSetDef pyopencv_ml_NormalBayesClassifier_Params_getseters[] =
{
    {NULL}  /* Sentinel */
};
...
static PyMethodDef pyopencv_ml_NormalBayesClassifier_Params_methods[] =
{

    {NULL,          NULL}
};

static void pyopencv_ml_NormalBayesClassifier_Params_specials(void)
{
    pyopencv_ml_NormalBayesClassifier_Params_Type.tp_base = NULL;
    pyopencv_ml_NormalBayesClassifier_Params_Type.tp_dealloc = pyopencv_ml_NormalBayesClassifier_Params_dealloc;
    pyopencv_ml_NormalBayesClassifier_Params_Type.tp_repr = pyopencv_ml_NormalBayesClassifier_Params_repr;
    pyopencv_ml_NormalBayesClassifier_Params_Type.tp_getset = pyopencv_ml_NormalBayesClassifier_Params_getseters;
    pyopencv_ml_NormalBayesClassifier_Params_Type.tp_methods = pyopencv_ml_NormalBayesClassifier_Params_methods;
}
...
{
    pyopencv_ml_KNearest_Type.tp_base = NULL;
...
static bool pyopencv_to(PyObject* src, cv::ml::KNearest::Params& dst, const char* name)
{
    PyObject* tmp;
    bool ok;

    if( PyMapping_HasKeyString(src, (char*)"defaultK") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"defaultK");
        ok = tmp && pyopencv_to(tmp, dst.defaultK);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"isclassifier") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"isclassifier");
        ok = tmp && pyopencv_to(tmp, dst.isclassifier);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"Emax") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"Emax");
        ok = tmp && pyopencv_to(tmp, dst.Emax);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"algorithmType") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"algorithmType");
        ok = tmp && pyopencv_to(tmp, dst.algorithmType);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    return true;
...
{
    pyopencv_ml_SVM_Type.tp_base = NULL;
...
static bool pyopencv_to(PyObject* src, cv::ml::SVM::Params& dst, const char* name)
{
    PyObject* tmp;
    bool ok;

    if( PyMapping_HasKeyString(src, (char*)"svmType") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"svmType");
        ok = tmp && pyopencv_to(tmp, dst.svmType);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"kernelType") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"kernelType");
        ok = tmp && pyopencv_to(tmp, dst.kernelType);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    ...
    if( PyMapping_HasKeyString(src, (char*)"classWeights") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"classWeights");
        ok = tmp && pyopencv_to(tmp, dst.classWeights);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"termCrit") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"termCrit");
        ok = tmp && pyopencv_to(tmp, dst.termCrit);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    return true;
...
{
    pyopencv_ml_EM_Type.tp_base = NULL;
...
static bool pyopencv_to(PyObject* src, cv::ml::EM::Params& dst, const char* name)
{
    PyObject* tmp;
    bool ok;
    ...
    if( PyMapping_HasKeyString(src, (char*)"covMatType") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"covMatType");
        ok = tmp && pyopencv_to(tmp, dst.covMatType);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"termCrit") )
...
{
    pyopencv_ml_DTrees_Type.tp_base = NULL;
...
static bool pyopencv_to(PyObject* src, cv::ml::DTrees::Params& dst, const char* name)
{
    PyObject* tmp;
    bool ok;

    if( PyMapping_HasKeyString(src, (char*)"maxCategories") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"maxCategories");
        ok = tmp && pyopencv_to(tmp, dst.maxCategories);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"maxDepth") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"maxDepth");
        ok = tmp && pyopencv_to(tmp, dst.maxDepth);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"minSampleCount") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"minSampleCount");
        ok = tmp && pyopencv_to(tmp, dst.minSampleCount);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"CVFolds") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"CVFolds");
        ok = tmp && pyopencv_to(tmp, dst.CVFolds);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"useSurrogates") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"useSurrogates");
        ok = tmp && pyopencv_to(tmp, dst.useSurrogates);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"use1SERule") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"use1SERule");
        ok = tmp && pyopencv_to(tmp, dst.use1SERule);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"truncatePrunedTree") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"truncatePrunedTree");
        ok = tmp && pyopencv_to(tmp, dst.truncatePrunedTree);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"regressionAccuracy") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"regressionAccuracy");
        ok = tmp && pyopencv_to(tmp, dst.regressionAccuracy);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"priors") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"priors");
        ok = tmp && pyopencv_to(tmp, dst.priors);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    return true;
...
{
    pyopencv_ml_RTrees_Type.tp_base = NULL;
...
static bool pyopencv_to(PyObject* src, cv::ml::RTrees::Params& dst, const char* name)
{
    PyObject* tmp;
    bool ok;

    if( PyMapping_HasKeyString(src, (char*)"calcVarImportance") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"calcVarImportance");
        ok = tmp && pyopencv_to(tmp, dst.calcVarImportance);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"nactiveVars") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"nactiveVars");
        ok = tmp && pyopencv_to(tmp, dst.nactiveVars);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"termCrit") )
    ...
    return pyopencv_to(src, (cv::ml::DTrees::Params&)dst, name);
}
...
{
    pyopencv_ml_Boost_Type.tp_base = NULL;
...
static bool pyopencv_to(PyObject* src, cv::ml::Boost::Params& dst, const char* name)
{
    PyObject* tmp;
    bool ok;

    if( PyMapping_HasKeyString(src, (char*)"boostType") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"boostType");
        ok = tmp && pyopencv_to(tmp, dst.boostType);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"weakCount") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"weakCount");
        ok = tmp && pyopencv_to(tmp, dst.weakCount);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"weightTrimRate") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"weightTrimRate");
        ok = tmp && pyopencv_to(tmp, dst.weightTrimRate);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    return pyopencv_to(src, (cv::ml::DTrees::Params&)dst, name);
...
{
    pyopencv_ml_ANN_MLP_Type.tp_base = NULL;
...
static bool pyopencv_to(PyObject* src, cv::ml::ANN_MLP::Params& dst, const char* name)
{
    PyObject* tmp;
    bool ok;

    if( PyMapping_HasKeyString(src, (char*)"layerSizes") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"layerSizes");
        ok = tmp && pyopencv_to(tmp, dst.layerSizes);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"activateFunc") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"activateFunc");
        ok = tmp && pyopencv_to(tmp, dst.activateFunc);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"fparam1") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"fparam1");
        ok = tmp && pyopencv_to(tmp, dst.fparam1);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"fparam2") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"fparam2");
        ok = tmp && pyopencv_to(tmp, dst.fparam2);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"termCrit") )
    ...
    if( PyMapping_HasKeyString(src, (char*)"trainMethod") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"trainMethod");
        ok = tmp && pyopencv_to(tmp, dst.trainMethod);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"bpDWScale") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"bpDWScale");
        ok = tmp && pyopencv_to(tmp, dst.bpDWScale);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"bpMomentScale") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"bpMomentScale");
        ok = tmp && pyopencv_to(tmp, dst.bpMomentScale);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"rpDW0") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"rpDW0");
        ok = tmp && pyopencv_to(tmp, dst.rpDW0);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"rpDWPlus") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"rpDWPlus");
        ok = tmp && pyopencv_to(tmp, dst.rpDWPlus);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"rpDWMinus") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"rpDWMinus");
        ok = tmp && pyopencv_to(tmp, dst.rpDWMinus);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"rpDWMin") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"rpDWMin");
        ok = tmp && pyopencv_to(tmp, dst.rpDWMin);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    if( PyMapping_HasKeyString(src, (char*)"rpDWMax") )
    {
        tmp = PyMapping_GetItemString(src, (char*)"rpDWMax");
        ok = tmp && pyopencv_to(tmp, dst.rpDWMax);
        Py_DECREF(tmp);
        if(!ok) return false;
    }
    return true;
...
static PyObject* pyopencv_cv_MSER_detectRegions(PyObject* self, PyObject* args, PyObject* kw)
{
    ...
    PyObject* pyobj_image = NULL;
    Mat image;
    PyObject* pyobj_msers = NULL;
    vector_vector_Point msers;
    PyObject* pyobj_bboxes = NULL;
    vector_Rect bboxes;

    const char* keywords[] = { "image", "msers", "bboxes", NULL };
    if( PyArg_ParseTupleAndKeywords(args, kw, "OOO:MSER.detectRegions", (char**)keywords, &pyobj_image, &pyobj_msers, &pyobj_bboxes) &&
        pyopencv_to(pyobj_image, image, ArgInfo("image", 0)) &&
        pyopencv_to(pyobj_msers, msers, ArgInfo("msers", 0)) &&
...
{
    {"detectRegions", (PyCFunction)pyopencv_cv_MSER_detectRegions, METH_VARARGS | METH_KEYWORDS, "detectRegions(image, msers, bboxes) -> None"},
