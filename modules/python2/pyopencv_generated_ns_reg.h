static PyMethodDef methods_cv[] = {
    ...
    {"Algorithm__create", (PyCFunction)pyopencv_cv_Algorithm__create, METH_VARARGS | METH_KEYWORDS, "Algorithm__create(name) -> retval"},
    {"Algorithm_getList", (PyCFunction)pyopencv_cv_Algorithm_getList, METH_VARARGS | METH_KEYWORDS, "Algorithm_getList() -> algorithms"},
    ...
    {"findTransformECC", (PyCFunction)pyopencv_cv_findTransformECC, METH_VARARGS | METH_KEYWORDS, "findTransformECC(templateImage, inputImage, warpMatrix[, motionType[, criteria]]) -> retval, warpMatrix"},
    ...
    {"matchTemplate", (PyCFunction)pyopencv_cv_matchTemplate, METH_VARARGS | METH_KEYWORDS, "matchTemplate(image, templ, method[, result]) -> result"},
...
static ConstDef consts_cv[] = {
    ...
    {"CAP_ANDROID_ANTIBANDING_50HZ", cv::CAP_ANDROID_ANTIBANDING_50HZ},
    {"CAP_ANDROID_ANTIBANDING_60HZ", cv::CAP_ANDROID_ANTIBANDING_60HZ},
    {"CAP_ANDROID_ANTIBANDING_AUTO", cv::CAP_ANDROID_ANTIBANDING_AUTO},
    {"CAP_ANDROID_ANTIBANDING_OFF", cv::CAP_ANDROID_ANTIBANDING_OFF},
    {"CAP_ANDROID_COLOR_FRAME", cv::CAP_ANDROID_COLOR_FRAME},
    {"CAP_ANDROID_COLOR_FRAME_BGR", cv::CAP_ANDROID_COLOR_FRAME_BGR},
    {"CAP_ANDROID_COLOR_FRAME_BGRA", cv::CAP_ANDROID_COLOR_FRAME_BGRA},
    {"CAP_ANDROID_COLOR_FRAME_RGB", cv::CAP_ANDROID_COLOR_FRAME_RGB},
    {"CAP_ANDROID_COLOR_FRAME_RGBA", cv::CAP_ANDROID_COLOR_FRAME_RGBA},
    {"CAP_ANDROID_FLASH_MODE_AUTO", cv::CAP_ANDROID_FLASH_MODE_AUTO},
    {"CAP_ANDROID_FLASH_MODE_OFF", cv::CAP_ANDROID_FLASH_MODE_OFF},
    {"CAP_ANDROID_FLASH_MODE_ON", cv::CAP_ANDROID_FLASH_MODE_ON},
    {"CAP_ANDROID_FLASH_MODE_RED_EYE", cv::CAP_ANDROID_FLASH_MODE_RED_EYE},
    {"CAP_ANDROID_FLASH_MODE_TORCH", cv::CAP_ANDROID_FLASH_MODE_TORCH},
    {"CAP_ANDROID_FOCUS_MODE_AUTO", cv::CAP_ANDROID_FOCUS_MODE_AUTO},
    {"CAP_ANDROID_FOCUS_MODE_CONTINUOUS_VIDEO", cv::CAP_ANDROID_FOCUS_MODE_CONTINUOUS_VIDEO},
    {"CAP_ANDROID_FOCUS_MODE_EDOF", cv::CAP_ANDROID_FOCUS_MODE_EDOF},
    {"CAP_ANDROID_FOCUS_MODE_FIXED", cv::CAP_ANDROID_FOCUS_MODE_FIXED},
    {"CAP_ANDROID_FOCUS_MODE_INFINITY", cv::CAP_ANDROID_FOCUS_MODE_INFINITY},
    {"CAP_ANDROID_FOCUS_MODE_MACRO", cv::CAP_ANDROID_FOCUS_MODE_MACRO},
    {"CAP_ANDROID_GREY_FRAME", cv::CAP_ANDROID_GREY_FRAME},
    {"CAP_ANDROID_WHITE_BALANCE_AUTO", cv::CAP_ANDROID_WHITE_BALANCE_AUTO},
    {"CAP_ANDROID_WHITE_BALANCE_CLOUDY_DAYLIGHT", cv::CAP_ANDROID_WHITE_BALANCE_CLOUDY_DAYLIGHT},
    {"CAP_ANDROID_WHITE_BALANCE_DAYLIGHT", cv::CAP_ANDROID_WHITE_BALANCE_DAYLIGHT},
    {"CAP_ANDROID_WHITE_BALANCE_FLUORESCENT", cv::CAP_ANDROID_WHITE_BALANCE_FLUORESCENT},
    {"CAP_ANDROID_WHITE_BALANCE_INCANDESCENT", cv::CAP_ANDROID_WHITE_BALANCE_INCANDESCENT},
    {"CAP_ANDROID_WHITE_BALANCE_SHADE", cv::CAP_ANDROID_WHITE_BALANCE_SHADE},
    {"CAP_ANDROID_WHITE_BALANCE_TWILIGHT", cv::CAP_ANDROID_WHITE_BALANCE_TWILIGHT},
    {"CAP_ANDROID_WHITE_BALANCE_WARM_FLUORESCENT", cv::CAP_ANDROID_WHITE_BALANCE_WARM_FLUORESCENT},
    {"CAP_ANY", cv::CAP_ANY},
    ...
    {"CAP_PROP_ANDROID_ANTIBANDING", cv::CAP_PROP_ANDROID_ANTIBANDING},
    {"CAP_PROP_ANDROID_AUTOGRAB", cv::CAP_PROP_ANDROID_AUTOGRAB},
    {"CAP_PROP_ANDROID_FLASH_MODE", cv::CAP_PROP_ANDROID_FLASH_MODE},
    {"CAP_PROP_ANDROID_FOCAL_LENGTH", cv::CAP_PROP_ANDROID_FOCAL_LENGTH},
    {"CAP_PROP_ANDROID_FOCUS_DISTANCE_FAR", cv::CAP_PROP_ANDROID_FOCUS_DISTANCE_FAR},
    {"CAP_PROP_ANDROID_FOCUS_DISTANCE_NEAR", cv::CAP_PROP_ANDROID_FOCUS_DISTANCE_NEAR},
    {"CAP_PROP_ANDROID_FOCUS_DISTANCE_OPTIMAL", cv::CAP_PROP_ANDROID_FOCUS_DISTANCE_OPTIMAL},
    {"CAP_PROP_ANDROID_FOCUS_MODE", cv::CAP_PROP_ANDROID_FOCUS_MODE},
    {"CAP_PROP_ANDROID_PREVIEW_FORMAT", cv::CAP_PROP_ANDROID_PREVIEW_FORMAT},
    {"CAP_PROP_ANDROID_PREVIEW_SIZES_STRING", cv::CAP_PROP_ANDROID_PREVIEW_SIZES_STRING},
    {"CAP_PROP_ANDROID_WHITE_BALANCE", cv::CAP_PROP_ANDROID_WHITE_BALANCE},
    ...
    {"CAP_PROP_MONOCROME", cv::CAP_PROP_MONOCROME},
    ...
    {"_InputArray_CUDA_MEM", cv::_InputArray::CUDA_MEM},
    {"_INPUT_ARRAY_CUDA_MEM", cv::_InputArray::CUDA_MEM},
    ...
    {"_InputArray_GPU_MAT", cv::_InputArray::GPU_MAT},
    {"_INPUT_ARRAY_GPU_MAT", cv::_InputArray::GPU_MAT},
...
static ConstDef consts_ml[] = {
    ...
    {"ANN_MLP_Params_BACKPROP", cv::ml::ANN_MLP::Params::BACKPROP},
    {"ANN_MLP_PARAMS_BACKPROP", cv::ml::ANN_MLP::Params::BACKPROP},
    {"ANN_MLP_Params_RPROP", cv::ml::ANN_MLP::Params::RPROP},
    {"ANN_MLP_PARAMS_RPROP", cv::ml::ANN_MLP::Params::RPROP},
...
static PyMethodDef methods_ocl[] = {
    ...
    {"isPerformanceCheckBypassed", (PyCFunction)pyopencv_cv_ocl_isPerformanceCheckBypassed, METH_VARARGS | METH_KEYWORDS, "isPerformanceCheckBypassed() -> retval"},
